...
,
    ...
    .log("ContextCode", row.ContextCode))
...
newTrial( "bye" ,
    newText("<p style=font-size:18px;>Your results have been saved, but you need to validate your participation below. This is a necessary step to approve your submission!</p>" +
			"<p style=font-size:18px;><a href='https://app.prolific.co/submissions/complete?cc=11447C24'>Click here to confirm my submission on Prolific</a>.</p>")
		.center()
        .print()
		.wait()
).setOption("hideProgressBar",true)
